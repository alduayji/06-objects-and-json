...
*/
// for (var [jasonJs, count, keys] of entries) {
//     console.log(` ${title.keys} ${date_taken.keys}s`)
//   };

//   for (var property1 in jasonJs) {
//     if (jasonJs.hasOwnProperty(items.title, items.date_taken) ){
//         console.log(title + "" + date_taken);
//   }
// }
...
for (let i = 0; i < flickerObj.items.length; i++) {
   ...
   var r = flickerObj.items[i].title;
   links.push(r)  
}
console.log(links);
...
var toString = JSON.stringify(links);
